...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../media/logo.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fav_btn_example.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../media/plus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.plus_site.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../media/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.site_settings.setIcon(icon4)
