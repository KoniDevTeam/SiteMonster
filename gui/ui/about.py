...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.text.setText(_translate("MainWindow", "Site Monster is an app for site admins, which will immediately notify you when your site goes down. This app is being developed by us, a young and promising team called 'Koni Dev Team'. We work to make this app better, stabler and much more useful.You can help us by fixing bugs or creating new features. Get more info in 'Contribution' section of ReadMe.md on our <a href=\"https://github.com/Nekit10/SiteMonster\">GitHub</a> page. Also you can donate money. Just send money on one of these cards with a note 'On SiteMonster developing':"))
