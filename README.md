...
You can download Site Monster 1.0.1 [here](https://github.com/KoniDevTeam/SiteMonsterPython/releases/tag/v1.0.1)
## Install from source on linux
Download latest source code from [here](https://github.com/KoniDevTeam/SiteMonsterPython/releases).
