...
def is_win10() -> bool:
    ...
    logging.debug("Checking for windows 10 -", is_win_10)
...
def is_win() -> bool:
    ...
    logging.debug("Checking for windows -", is_win_)
...
def is_mac_os() -> bool:
    ...
    logging.debug("Checking for macOS -", is_mac)
...
def is_linux() -> bool:
    ...
    logging.debug("Checking for linux -", is_linux_)
